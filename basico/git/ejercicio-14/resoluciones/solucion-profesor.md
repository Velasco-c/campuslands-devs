# Solución de profesor: Pull request de laboratorio químico
...
git checkout dev
git pull origin dev
git checkout -b alumno/nombre-apellido/ejercicio-14
agregar solucion en resoluciones
git add .
git commit -m "feat(git): resolver ejercicio 14"
git push -u origin alumno/nombre-apellido/ejercicio-14
abrir PR hacia dev con descripcion y validacion
```
