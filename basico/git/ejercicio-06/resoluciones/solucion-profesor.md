# Solución de profesor: Pull antes de modificar tabla de fútbol
...
git checkout dev
git pull origin dev
git checkout -b alumno/nombre-apellido/ejercicio-06
resolver ejercicio
git add .
git commit -m "feat(git): resolver ejercicio 06"
```
